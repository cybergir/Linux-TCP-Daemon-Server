...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ADMIN\Desktop\Standard Introductory Test Task'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ADMIN\Desktop\Standard Introductory Test Task\Scripts\deactivate.nu'
